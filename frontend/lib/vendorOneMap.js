...
function GetOneMap(divName, baseMap, optionalProps) {
    ...
    dojo.addOnLoad(function () {
        ...
        var OneMap3 = new _Map(_OneMapDiv, {
            extent: startExtent, logo: false,
            sliderStyle: "large"
        });
...
function initWMTS() {
    ...
    ], function (Map, _WMTSLayer, _WMTSLayerInfo,
...
function GetSearchResults(callback, url) {
    //debugger;
    var obj = this;
    ...
    $.getJSON(url + "&callback=?", function (parsedJSON) {
        ...
        console.log(searchval, whereclause, otptFlds, returngeom);
...
var _OneMapGlobalToken = '';
document.write('<link rel="stylesheet" type="text/css" href="http://t1.onemap.sg/arcgis_js_api/library/3.10/arcgis/js/dojo/dijit/themes/tundra/tundra.css"/>');
document.write('<link rel="stylesheet" type="text/css" href="http://t1.onemap.sg/arcgis_js_api/library/3.10/arcgis/js/esri/css/esri.css"/>');
document.write('<script type="text/javascript" src="http://t1.onemap.sg/arcgis_js_api/library/3.10/arcgis/init.js"></script>');
var _OneMapGlobalToken = 'qo/s2TnSUmfLz+32CvLC4RMVkzEFYjxqyti1KhByvEacEdMWBpCuSSQ+IFRT84QjGPBCuz/cBom8PfSm3GjEsGc8PkdEEOEr';
var projSys = '';